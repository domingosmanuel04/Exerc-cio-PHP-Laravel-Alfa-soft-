      ...
      <div class="page-header min-vh-75">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Acessar Dashboard</h3>
                </div>
                <div class="card-body">
        ...
        @endif
                  ...
                  @csrf
                    ...
                    <div class="mb-3">
                      <input type="passord" class="form-control" placeholder="Password" name="password" required autocomplete="current-password">
                    </div>
                ...
                @endif
                      <button class="btn bg-gradient-info w-100 mt-4 mb-0" type="submit">Entrar</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    Não tens uma Conta?
                    <a href="/register" class="text-info text-gradient font-weight-bold">Cadastrar</a>
                  </p>
                </div>
              </div>
            </div>
